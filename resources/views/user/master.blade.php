      ...
      <div class="container-fluid px-md-5">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            ...
            <h1 class="mb-4">Sistem Rekomendasi Hotel</h1>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 d-flex">
    				<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end" style="background-image:url(images/about.jpg);">
    					<a href="/usertemplate/https://vimeo.com/45830194" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image align-self-center">
	                    <img src="/usertemplate/images/person_1.jpg" alt="">
	                  </div>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image align-self-center">
	                    <img src="/usertemplate/images/person_2.jpg" alt="">
	                  </div>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image align-self-center">
	                    <img src="/usertemplate/images/person_3.jpg" alt="">
	                  </div>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image align-self-center">
	                    <img src="/usertemplate/images/person_4.jpg" alt="">
	                  </div>
